        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-8">
                <div id="wizard_container">
                    ...
                    <!-- /top-wizard -->
                    {{-- <form method="post" action="{{ route('store-inquiry') }}" id="inquiry-form" data-tf-element-role="offer">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control required"
                                        placeholder="First Name *" id="first_name" oninput="checkValidInput(this)" required
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Last Name *"
                                        id="last_name" oninput="checkValidInput(this)" required name="last_name" data-tf-element-role="consent-grantor-last_name">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="phone" placeholder="Phone number *"
                                        ...
                                        name="phone" class="form-control" data-tf-element-role="consent-grantor-phone">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" placeholder="Email *" required
                                        name="email" oninput="checkValidInput(this)" class="form-control" data-tf-element-role="consent-grantor-email">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea rows="5" id="message" placeholder="Your message" name="message"
                                        class="form-control" oninput="checkValidInput(this)" style="height:100px;" data-tf-element-role="consent-grantor-message"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="container_check" data-tf-element-role="contact-method">By checking this box and clicking “SUBMIT CLAIM
                                        REVIEW” I represent that I am the line subscriber or primary user of the
                                        phone number above (including my wireless number if provided) and provide my
                                        express consent authorizing PLM, <span data-tf-element-role="consent-advertiser-name">Michaels &amp; Sterling and our marketing
                                        partners</span> to contact me by telephone (including text messages), delivered via
                                        automated technology to the phone number above regarding legal products
                                        and/or offerings even if I am on a Federal, State or Do-Not-Call registry. I
                                        understand that these calls/texts may be delivered via automated technology,
                                        at any time in any way, including but not limited to telemarketing calls
                                        using an auto-dialer, text, fax, or email, even if these result in charges
                                        by my carrier. I further represent that I am a U.S. Resident over the age of
                                        18, understand and agree to the <a
                                            href="{{route('privacy-policy')}}">Privacy Policy</a>, <a
                                            href="{{route('terms-condition')}}">Terms &amp;
                                            Conditions</a>, and <a
                                            href="https://depolawsuitnow.com/CCPA">California Privacy Notice</a>
                                        and agree to receive email promotions from PLM, Michaels &amp; Sterling LLC
                                        and our marketing partners. I understand and agree that this site uses
                                        ...
                                        <input type="checkbox" name="accept_terms" value="Yes" data-tf-element-role="consent-opt-in" required>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <p><input type="submit" value="Submit" data-tf-element-role="submit" class="btn_1 add_bottom_15"
                                        id="submit-contact"></p>
                            </div>
                        </div>
                    </form> --}}
