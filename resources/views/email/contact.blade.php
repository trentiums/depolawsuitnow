...
<!--[if !gte mso 9]><!----><span class="mcnPreviewText"
                                 style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Email Notify</span>
<!--<![endif]-->
<!--*|END:IF|*-->
<center>
                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                        <tbody><tr>
                                                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                ...
                                                                <a href="{{url('')}}" target="_blank">AAAAAA</a>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                <h3 class="null" style="text-align: center;">New Lead
                                                                    from Customer</h3>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                User {{$mailData['fname'] . ' ' . $mailData['lname']}}
                                                                has sent a new request.
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <table width="100%" align="center" cellspacing="0" cellpadding="10"
                                                        ...
                                                        <tr>
                                                            @if(isset($mailData['xxTrustedFormToken']) && !empty($mailData['xxTrustedFormToken']))
                                                                <th align="center">
                                                                    <div style="line-height: 24px;">
                                                        ...
                                                        <tr>
                                                            @if(isset($mailData['xxTrustedFormCertUrl']) && !empty($mailData['xxTrustedFormCertUrl']))
                                                                <th align="center">
                                                                    <div style="line-height: 24px;">
                                                                        <font face="Arial, Helvetica, sans-serif"
                                                                              size="4" color="#57697e"
                                                        ...
                                                        <tr>
                                                            @if(isset($mailData['xxTrustedFormPingUrl']) && !empty($mailData['xxTrustedFormPingUrl']))
                                                                <th align="center">
                                                                    <div style="line-height: 24px;">
                                                                        <font face="Arial, Helvetica, sans-serif"
                                                                              size="4" color="#57697e"
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                                                        <tbody><tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #222222;">
                                                                ...
                                                                <em>Copyright © {{date("Y")}} Wlcm Events, All rights reserved.</em><br>
                                                                <br>
